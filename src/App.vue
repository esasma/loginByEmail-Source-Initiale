...
<template>
  <header>
    ...
    <div class="wrapper" id="signOut">
      ...
      <button v-on:click="register()" class="rounded border border-black">
        Sign Up
      </button>
...
<script>
const SUPABASE_URL = "https://gzmhxughicuplszwdxaq.supabase.co";
const SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imd6bWh4dWdoaWN1cGxzendkeGFxIiwicm9sZSI6ImFub24iLCJpYXQiOjE2NjMzMzY5MDYsImV4cCI6MTk3ODkxMjkwNn0.C3vkzpB3lGecjR1c_ndT_Hpg5hGn64iGPH14KEIMdAk"
